...
| Concepts | 206 | [Concept List](./concept-list.md) | Concepts from learning graph |
| Glossary Terms | 206 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 86 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 140 | - | Questions across all chapters |
| MicroSims | 81 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
| Total Words | 151,864 | 97,517 | Words in markdown files |
| Links | 655 | 149 | Hyperlinks in markdown format |
| Equivalent Pages | 665 | 447 | Estimated pages (250 words/page + visuals) |
