...
|---|---------|-------|--------|-------|
| 1 | Concepts | 206 | Required | Concepts from learning graph |
| 2 | Chapters | 14 | Required | Chapter directories with index.md |
| 3 | MicroSims | 81 | Recommended | Interactive simulations in docs/sims/ |
...
| 7 | Glossary Terms | 206 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 86 | Recommended | Questions in faq.md |
| 9 | Words | 239,772 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 69 | 69 | H4 headers starting with '#### Diagram:' |
| Equations | 71 | 55 | LaTeX expressions (inline and display) |
| Total Words | 239,772 | 97,517 | Words in markdown files |
| Links | 792 | 149 | Hyperlinks in markdown format |
| Equivalent Pages | 1016 | 447 | Estimated pages (250 words/page + visuals) |
