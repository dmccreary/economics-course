...
- Longest dependency chains (20 concepts)
...
- 13 taxonomy categories for economics concepts
- Category organization - foundational elements first, capstone projects last
- Balanced categories (2.4% - 20.4% each)
- All categories under 30% threshold
- Clear abbreviations for use in CSV file
...
reasonable number of concepts. No category contains over 30% of concepts.
